 ...
 *
 * AI機能（レポート生成）は NPC_WP_Healthcheck::is_ai_available() が false の時、
...
<div class="wrap npc-healthcheck">
    ...
    <?php if ( ! $ai_available ) : ?>
        ...
        <div class="notice notice-info">
            ...
            <pre style="background: #23282d; color: #eee; padding: 8px 12px; border-radius: 4px; margin: 4px 0; font-size: 12px;">define( 'NPC_HEALTHCHECK_API_KEY', 'sk-ant-xxxx' );</pre>
            <p>
                AIレポートは
    ...
    <div id="npc-history" style="display:none;">
        <h2>診断履歴</h2>
        <p class="npc-history-note">直近<?php echo (int) NPC_HEALTHCHECK_HISTORY_LIMIT; ?>件を保持します。古いものから自動削除されます。</p>
